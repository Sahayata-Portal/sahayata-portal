...
manual = {
  ...
  "Labourers":["Labourers","श्रमिक"],
  "Employment Schemes":["Employment Schemes","रोजगार योजनाएं"],
  "Social Welfare Schemes":["Social Welfare Schemes","समाज कल्याण योजनाएं"],
  "Women":["Women","महिलाएं"],
  "Subscribe for all latest updates!":["Subscribe for all latest updates!","सभी नए अपडेट्स के लिए सब्सक्राइब करें!"],
  ...
  "Subscribe | Sahayata Portal":["Subscribe | Sahayata Portal","सब्सक्राइब करें! | सहायता पोर्टल"],
  "Unsubscribe | Sahayata Portal":["Unsubscribe | Sahayata Portal","अनसब्सक्राइब करें | सहायता पोर्टल"],
